...
const ReviewCard = ({imgUrl, date, name, userName, review}) => {
  return (
    <div className='w-full h-auto bg-neutral-200/80 rounded-md p-3 border border-neutral-100'>
        <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-x-2">
                <img src={imgUrl} alt="reviewer img" className="w-11 h-11 objext-cover object-center rounded-full border-neutral-200" />
                <div className="div">
