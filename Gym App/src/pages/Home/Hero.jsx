...
const Hero = () => {
  const swiperData = [
    {
      id: 1,
      bgImg: "https://tinyurl.com/yeyr6u9n",
    ...
    {
      id: 3,
      bgImg: "https://tinyurl.com/2ypxpn22",
  ...
  return (
    <>
     ...
     <Swiper
      ...
      >
        {/*loop the carsoul component*/}
        {swiperData.map((data) => (
           <SwiperSlide className="w-full h-[70vh] relative "
           style={{
       ...
       > 
          {/*overlap box with some black color*/}
         ...
         <div className="w-full h-full items-center justify-center flex flex-col z-10
             ...
             <h5 className=" lg:text-4xl md:text-3xl sm:text-2xl text-2xl text-indigo-400 font-semibold mb-2 uppercase"
               >{data.slogan}</h5>
             <h1 className="lg:text-8xl md:text-7xl sm: text-5xl font-bold text-white mb-4 uppercase">
              {data.title}
             </h1>
             <p className="lg:text-lg md:text-base sm:text-base text-base text-white font-medium-mb-6 text-center">
               {data.desc}
             </p>
             <PrimaryBtn className="lg:w-[15%] md:w-[35%] sm:w-[75%] w-[80%] h-[14%] text-xl font-semibold rounded-full">Get Started</PrimaryBtn>
         </div>
       </SwiperSlide>
        ))}
      </Swiper>
      {/*banner type card*/}
      <div className="w-full h-full flex items-center lg:justify-between 
      md:justify-between sm:justify-center lg:gap-7 md:gap-5 sm:gap-5 
      gap-5 lg:px-24 md:px-16 sm:px-6 px-6 mt-6 flex-wrap">
        ...
        duration-700 cursor-pointer lg:w-fit md:w-[48%] sm:w-[48%] w-full
        lg:py-6 md:py-7 sm:py-8 py-9 px-10 bg-black/10 hover:bg-black/30"> 
        ...
        lg:py-6 md:py-7 sm:py-8 py-9 px-10 bg-black/10 hover:bg-black/30"> 
         ...
         <p className="text-lg text-gray-600 font-medium">Years of Experiance</p>
        </div>
        <div className="flex items-center justify-center flex-col rounded-md ease-out 
        duration-700 cursor-pointer lg:w-fit md:w-[48%] sm:w-[48%] w-full
        lg:py-6 md:py-7 sm:py-8 py-9 px-10 bg-black/10 hover:bg-black/30"> 
